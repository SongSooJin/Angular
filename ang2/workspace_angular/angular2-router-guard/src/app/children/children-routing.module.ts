  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        // children 문자열로 ChildrenComponent 컴포넌트를 배치한다.
        // ChildrenComponent 컴포넌트 그화면 내부에 router-outlet설정이 존재한다. 
        // 이곳에 어떤 컴포넌트를 배치할지 추가적인 설정이 필요하다.
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            // ChildrenComponent 영역 하부에 사용하는 자식 컴퍼런트들이
            // 화면에 배치되기 전에 공통적으로 처리해야 하는 로직이 있다면
